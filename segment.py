...
class Segment:
    ...
    def add_results_to_database(self, segment):
        ...
        self.logger.debug(f"Added Segment with Policy ID {self.policy_id}, Segment ID {self.segment_id} to the database.")
    ...
    def process_segment(self):
        ...
        main_predictions = self.models['Main']['model'].predict_proba(segment_tensor)
        ...
        main_predictions = main_predictions[0, :]
        ...
        self.logger.debug(f"Classified segment for Policy ID {self.policy_id}, Segment ID {self.segment_id}. Adding to the database now.")
        
        # Add policy classification results to the database.
        self.add_results_to_database(current_segment)
